            ...
            <div className="w-full max-w-md bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl relative overflow-hidden">
                ...
                <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                    ...
                    <div className="flex items-start space-x-2 ml-1 py-1">
                        <input type="checkbox" id="terms" className="mt-1 w-4 h-4 rounded border-white/10 bg-white/5 text-purple-600 focus:ring-purple-500/20" />
                        <label htmlFor="terms" className="text-xs text-gray-400 leading-relaxed">
                            Acepto los <a href="#" className="text-purple-400 hover:underline">Términos de Servicio</a> y la <a href="#" className="text-purple-400 hover:underline">Política de Privacidad</a>
                        </label>
                    </div>

                    <button className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white font-semibold py-3 rounded-lg shadow-lg shadow-purple-900/30 transition-all hover:scale-[1.02] active:scale-[0.98] mt-2">
                        Crear cuenta
                    </button>
                </form>
                ...
                <div className="mt-8 relative text-center">
                    ...
                    <span className="relative bg-[#1a1129] px-4 text-sm text-gray-500">O regístrate con</span>
                </div>

                <div className="mt-6 flex gap-4">
                    <button className="flex-1 bg-white/5 border border-white/10 hover:bg-white/10 text-white font-medium py-2.5 rounded-lg transition-all flex items-center justify-center gap-3 active:scale-[0.98]">
                ...
                <p className="mt-8 text-center text-gray-400 text-sm">
                    ...
                    <Link to="/login" className="text-purple-400 font-semibold hover:text-purple-300 transition-colors">Inicia sesión</Link>
                </p>
            </div>
        </div>
    );
